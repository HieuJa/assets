    ...
    $('ul.products.woovina-row.grid li.product, div.wew-woo-slider ul.products li.product').each(function(index, item) {
        ...
        var prdtitle   = $(item).find('li.title');
        var woodesc    = $(item).find('li.woo-desc');
        var prdinner   = $(item).find('li.inner');
        ...
        var prdcontent = $('<div class="content-product"></div>');
        var badge   = $('<div class="prd-badge"></div>')
        // Add tooltip for buttons
        $("<div class='tooltip for-cart'>" + atctext + "</div>").appendTo($(addtocart));
        ...
        $(prdtitle).appendTo($(prdcontent));
        $(woodesc).appendTo($(prdcontent));
        $(prdinner).appendTo($(prdcontent));
        $(wrapper).appendTo($(prdcontent));

        $(pach).appendTo($(entryimage));
        $(pach).clone().appendTo($(imgwrap));

        $(prdcontent).appendTo($(wooentryinner));
